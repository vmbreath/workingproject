        ...
        return(
            <div className={'legend'}>
                ...
                <p>Сальмонеллы вида S.enterica делятся на несколько подвидов и обозначаются следующими символами:<br />
                    ...
                    V - Вид S.bongori - для серовара S.bongori subsp. bongori. Все серовары вида S.bongori имеют символ V.<br />
                    ...
                    Серовары других подвидов вида S.enterica и вида S.bongori обозначаются номером подвида и их антигенной формулой:<br />
