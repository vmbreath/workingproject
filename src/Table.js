...
class Table extends Component {
    ...
    render() {
        const PopularSalmonel = ['Paratyphi A', 'Paratyphi B', 'Typhimurium', 'Stanley', 'Heidelberg', 'Reading', 'Derby', 'Abortusequi', 'Abortusovis', 'Brandenburg', 'Bispebjerg', 'Abony', 'Kisangani', 'Altendorf', 'Santpaul', 'Stanleyville', 'Paratyphi C', 'Choleraesuis', 'Thompson', 'Virchow', 'Oranienburg', 'Potsdam', 'Tennessee', 'Isangi', 'Bareilly', 'Infantis', 'Newport', 'Bovismorbificans', 'Glostrup', 'Muenchen', 'Kentucky', 'Chailey', 'Sandow', 'Typhi', 'Enteritidis', 'Dublin', 'Rostock', 'Moscow', 'Sendai', 'Victoria II', 'Eastbourne', 'Panama', 'Gallinarum', 'London', 'Anatum', 'Lexington', 'Weltevreden', 'Meleagridis', 'Give', 'Amager', 'Muenster', 'Nyborg', 'Senftenberg', 'Aberdeen', 'Rubislaw', 'Worthington', 'Poona', 'Carrau', 'Onderstepoort', 'Buzu', 'Hvittingfoss', 'Gaminara', 'Kirkee', 'Minnesota', 'Kuessel', 'Urbana', 'Adelaide', 'Inverness', 'Champaign', 'Riogrande', 'Millesi', 'Waycross', 'Weslaco', 'Ahuza', 'Niarembe', 'Deversoir', 'Kaolack', 'Dahlem', 'Dougi II', 'Utrecht', 'Bordeaux II', 'Uccle', 'Crossness'];
